 ...
 * @generated
 */
public class TypeNameType2Impl extends EObjectImpl implements TypeNameType2 {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getTypeNameType2();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.TYPE_NAME_TYPE2__VALUE, oldValue, value));
	}
	...
	public void setConstrained(boolean newConstrained) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.TYPE_NAME_TYPE2__CONSTRAINED, oldConstrained, constrained, !oldConstrainedESet));
	}
	...
	public void unsetConstrained() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.TYPE_NAME_TYPE2__CONSTRAINED, oldConstrained, CONSTRAINED_EDEFAULT, oldConstrainedESet));
	}
