...
public class ViewTypeImpl extends EObjectImpl implements ViewType {
	 ...
	 * @ordered
	 */
	protected EList constraintSetRef;
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getViewType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList getEnvIdentifier() {
		if (envIdentifier == null) {
			envIdentifier = new EDataTypeEList(String.class, this, _1Package.VIEW_TYPE__ENV_IDENTIFIER);
		}
	...
	public NotificationChain basicSetHierarchyRef(LibraryRefType newHierarchyRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__HIERARCHY_REF, oldHierarchyRef, newHierarchyRef);
	...
	public void setHierarchyRef(LibraryRefType newHierarchyRef) {
		if (newHierarchyRef != hierarchyRef) {
			...
			if (hierarchyRef != null)
				msgs = ((InternalEObject)hierarchyRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__HIERARCHY_REF, null, msgs);
			if (newHierarchyRef != null)
				msgs = ((InternalEObject)newHierarchyRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__HIERARCHY_REF, null, msgs);
			msgs = basicSetHierarchyRef(newHierarchyRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__HIERARCHY_REF, newHierarchyRef, newHierarchyRef));
	}
	...
	public NotificationChain basicSetLanguage(LanguageType newLanguage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__LANGUAGE, oldLanguage, newLanguage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLanguage(LanguageType newLanguage) {
		if (newLanguage != language) {
			NotificationChain msgs = null;
			if (language != null)
				msgs = ((InternalEObject)language).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__LANGUAGE, null, msgs);
			if (newLanguage != null)
				msgs = ((InternalEObject)newLanguage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__LANGUAGE, null, msgs);
			msgs = basicSetLanguage(newLanguage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__LANGUAGE, newLanguage, newLanguage));
	}
	...
	public void setModelName(String newModelName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__MODEL_NAME, oldModelName, modelName));
	}
	...
	public EList getDefaultFileBuilder() {
		if (defaultFileBuilder == null) {
			defaultFileBuilder = new EObjectContainmentEList(FileBuilderType.class, this, _1Package.VIEW_TYPE__DEFAULT_FILE_BUILDER);
		}
	...
	public EList getFileSetRef() {
		if (fileSetRef == null) {
			fileSetRef = new EObjectContainmentEList(FileSetRefType.class, this, _1Package.VIEW_TYPE__FILE_SET_REF);
		}
		return fileSetRef;
	}
	 ...
	 * @generated
	 */
	public EList getConstraintSetRef() {
		if (constraintSetRef == null) {
			constraintSetRef = new EDataTypeEList(String.class, this, _1Package.VIEW_TYPE__CONSTRAINT_SET_REF);
		}
	...
	public NotificationChain basicSetWhiteboxElementRefs(WhiteboxElementRefsType newWhiteboxElementRefs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__WHITEBOX_ELEMENT_REFS, oldWhiteboxElementRefs, newWhiteboxElementRefs);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWhiteboxElementRefs(WhiteboxElementRefsType newWhiteboxElementRefs) {
		if (newWhiteboxElementRefs != whiteboxElementRefs) {
			...
			if (whiteboxElementRefs != null)
				msgs = ((InternalEObject)whiteboxElementRefs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__WHITEBOX_ELEMENT_REFS, null, msgs);
			if (newWhiteboxElementRefs != null)
				msgs = ((InternalEObject)newWhiteboxElementRefs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__WHITEBOX_ELEMENT_REFS, null, msgs);
			msgs = basicSetWhiteboxElementRefs(newWhiteboxElementRefs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__WHITEBOX_ELEMENT_REFS, newWhiteboxElementRefs, newWhiteboxElementRefs));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.VIEW_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.VIEW_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case _1Package.VIEW_TYPE__CONSTRAINT_SET_REF:
				...
				getConstraintSetRef().addAll((Collection)newValue);
				return;
			case _1Package.VIEW_TYPE__WHITEBOX_ELEMENT_REFS:
