 ...
 * @generated
 */
public class OnSlaveTypeImpl extends EObjectImpl implements OnSlaveType {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getOnSlaveType();
	}
	...
	public void setPresence(PresenceType newPresence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE__PRESENCE, oldPresence, presence, !oldPresenceESet));
	}
	...
	public void unsetPresence() {
		...
		presenceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.ON_SLAVE_TYPE__PRESENCE, oldPresence, PRESENCE_EDEFAULT, oldPresenceESet));
	}
	...
	public NotificationChain basicSetService(ServiceType1 newService, NotificationChain msgs) {
		...
		service = newService;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE__SERVICE, oldService, newService);
	...
	public void setService(ServiceType1 newService) {
		if (newService != service) {
			...
			if (service != null)
				msgs = ((InternalEObject)service).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.ON_SLAVE_TYPE__SERVICE, null, msgs);
			if (newService != null)
				msgs = ((InternalEObject)newService).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.ON_SLAVE_TYPE__SERVICE, null, msgs);
			msgs = basicSetService(newService, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE__SERVICE, newService, newService));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _1Package.ON_SLAVE_TYPE__SERVICE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _1Package.ON_SLAVE_TYPE__PRESENCE:
				return getPresence();
			case _1Package.ON_SLAVE_TYPE__SERVICE:
				return getService();
		}
