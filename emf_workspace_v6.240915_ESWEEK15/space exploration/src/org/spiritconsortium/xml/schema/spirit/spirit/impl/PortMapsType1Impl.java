 ...
 * @generated
 */
public class PortMapsType1Impl extends EObjectImpl implements PortMapsType1 {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getPortMapsType1();
	}
	...
	public EList getPortMap() {
		if (portMap == null) {
			portMap = new EObjectContainmentEList(PortMapType1.class, this, _1Package.PORT_MAPS_TYPE1__PORT_MAP);
		}
		return portMap;
	}
