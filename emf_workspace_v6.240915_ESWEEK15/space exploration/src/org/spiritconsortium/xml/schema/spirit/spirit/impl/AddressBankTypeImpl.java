 ...
 * @generated
 */
public class AddressBankTypeImpl extends EObjectImpl implements AddressBankType {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getAddressBankType();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__NAME, oldName, name));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetBaseAddress(BaseAddressType1 newBaseAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__BASE_ADDRESS, oldBaseAddress, newBaseAddress);
	...
	public void setBaseAddress(BaseAddressType1 newBaseAddress) {
		if (newBaseAddress != baseAddress) {
			...
			if (baseAddress != null)
				msgs = ((InternalEObject)baseAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.ADDRESS_BANK_TYPE__BASE_ADDRESS, null, msgs);
			if (newBaseAddress != null)
				msgs = ((InternalEObject)newBaseAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.ADDRESS_BANK_TYPE__BASE_ADDRESS, null, msgs);
			msgs = basicSetBaseAddress(newBaseAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__BASE_ADDRESS, newBaseAddress, newBaseAddress));
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, _1Package.ADDRESS_BANK_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList getAddressBlock() {
		return getGroup().list(_1Package.eINSTANCE.getAddressBankType_AddressBlock());
	}
	...
	public EList getBank() {
		return getGroup().list(_1Package.eINSTANCE.getAddressBankType_Bank());
	}
	...
	public EList getSubspaceMap() {
		return getGroup().list(_1Package.eINSTANCE.getAddressBankType_SubspaceMap());
	}
	...
	public void setUsage(UsageType1 newUsage) {
		...
		usageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__USAGE, oldUsage, usage, !oldUsageESet));
	}
	...
	public void unsetUsage() {
		...
		usageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.ADDRESS_BANK_TYPE__USAGE, oldUsage, USAGE_EDEFAULT, oldUsageESet));
	}
	...
	public void setVolatile(boolean newVolatile) {
		...
		volatileESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__VOLATILE, oldVolatile, volatile_, !oldVolatileESet));
	}
	...
	public void unsetVolatile() {
		...
		volatileESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.ADDRESS_BANK_TYPE__VOLATILE, oldVolatile, VOLATILE_EDEFAULT, oldVolatileESet));
	}
	...
	public void setAccess(AccessType newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__ACCESS, oldAccess, access));
	}
	...
	public NotificationChain basicSetParameters(ParametersType1 newParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__PARAMETERS, oldParameters, newParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParameters(ParametersType1 newParameters) {
		if (newParameters != parameters) {
			NotificationChain msgs = null;
			if (parameters != null)
				msgs = ((InternalEObject)parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.ADDRESS_BANK_TYPE__PARAMETERS, null, msgs);
			if (newParameters != null)
				msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.ADDRESS_BANK_TYPE__PARAMETERS, null, msgs);
			msgs = basicSetParameters(newParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__PARAMETERS, newParameters, newParameters));
	}
	...
	public NotificationChain basicSetVendorExtensions(VendorExtensionsType newVendorExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__VENDOR_EXTENSIONS, oldVendorExtensions, newVendorExtensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorExtensions(VendorExtensionsType newVendorExtensions) {
		if (newVendorExtensions != vendorExtensions) {
			...
			if (vendorExtensions != null)
				msgs = ((InternalEObject)vendorExtensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.ADDRESS_BANK_TYPE__VENDOR_EXTENSIONS, null, msgs);
			if (newVendorExtensions != null)
				msgs = ((InternalEObject)newVendorExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.ADDRESS_BANK_TYPE__VENDOR_EXTENSIONS, null, msgs);
			msgs = basicSetVendorExtensions(newVendorExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__VENDOR_EXTENSIONS, newVendorExtensions, newVendorExtensions));
	}
	...
	public void setBankAlignment(BankAlignmentType newBankAlignment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ADDRESS_BANK_TYPE__BANK_ALIGNMENT, oldBankAlignment, bankAlignment, !oldBankAlignmentESet));
	}
	...
	public void unsetBankAlignment() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.ADDRESS_BANK_TYPE__BANK_ALIGNMENT, oldBankAlignment, BANK_ALIGNMENT_EDEFAULT, oldBankAlignmentESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case _1Package.ADDRESS_BANK_TYPE__ADDRESS_BLOCK:
				return ((InternalEList)getAddressBlock()).basicRemove(otherEnd, msgs);
			case _1Package.ADDRESS_BANK_TYPE__BANK:
				return ((InternalEList)getBank()).basicRemove(otherEnd, msgs);
			case _1Package.ADDRESS_BANK_TYPE__SUBSPACE_MAP:
