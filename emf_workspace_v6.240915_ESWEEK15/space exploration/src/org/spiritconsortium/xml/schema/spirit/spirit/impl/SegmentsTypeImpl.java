 ...
 * @generated
 */
public class SegmentsTypeImpl extends EObjectImpl implements SegmentsType {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getSegmentsType();
	}
	...
	public EList getSegment() {
		if (segment == null) {
			segment = new EObjectContainmentEList(SegmentType.class, this, _1Package.SEGMENTS_TYPE__SEGMENT);
		}
		return segment;
	}
