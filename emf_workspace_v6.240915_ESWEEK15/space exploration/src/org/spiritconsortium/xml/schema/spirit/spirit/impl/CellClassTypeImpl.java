 ...
 * @generated
 */
public class CellClassTypeImpl extends EObjectImpl implements CellClassType {
	/**
	 ...
	 * @ordered
	 */
	protected static final CellClassValueType VALUE_EDEFAULT = CellClassValueType.COMBINATIONAL_LITERAL;
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getCellClassType();
	}
	...
	public void setValue(CellClassValueType newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.CELL_CLASS_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.CELL_CLASS_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setCellStrength(CellStrengthValueType newCellStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.CELL_CLASS_TYPE__CELL_STRENGTH, oldCellStrength, cellStrength, !oldCellStrengthESet));
	}
	...
	public void unsetCellStrength() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.CELL_CLASS_TYPE__CELL_STRENGTH, oldCellStrength, CELL_STRENGTH_EDEFAULT, oldCellStrengthESet));
	}
