 ...
 * @generated
 */
public class WhiteboxElementRefTypeImpl extends EObjectImpl implements WhiteboxElementRefType {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getWhiteboxElementRefType();
	}
	 ...
	 * @generated
	 */
	public EList getWhiteboxPath() {
		if (whiteboxPath == null) {
			whiteboxPath = new EObjectContainmentEList(WhiteboxPathType.class, this, _1Package.WHITEBOX_ELEMENT_REF_TYPE__WHITEBOX_PATH);
		}
		return whiteboxPath;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.WHITEBOX_ELEMENT_REF_TYPE__NAME, oldName, name));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case _1Package.WHITEBOX_ELEMENT_REF_TYPE__WHITEBOX_PATH:
				...
				getWhiteboxPath().addAll((Collection)newValue);
				return;
			case _1Package.WHITEBOX_ELEMENT_REF_TYPE__NAME:
