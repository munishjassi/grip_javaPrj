...
/**
 * This is the item provider adapter for a {@link org.spiritconsortium.xml.schema.spirit.spirit.ConnectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionType_maxConnections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionType_maxConnections_feature", "_UI_ConnectionType_type"),
				 _1Package.eINSTANCE.getConnectionType_MaxConnections(),
				 true,
				 false,
				 false,
	...
	protected void addMinConnectionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionType_minConnections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionType_minConnections_feature", "_UI_ConnectionType_type"),
				 _1Package.eINSTANCE.getConnectionType_MinConnections(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		BigInteger labelValue = ((ConnectionType)object).getMaxConnections();
