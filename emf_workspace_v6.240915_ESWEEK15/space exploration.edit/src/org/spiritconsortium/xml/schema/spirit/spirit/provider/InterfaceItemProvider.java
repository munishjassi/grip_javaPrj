...
/**
 * This is the item provider adapter for a {@link org.spiritconsortium.xml.schema.spirit.spirit.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_busRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_busRef_feature", "_UI_Interface_type"),
				 _1Package.eINSTANCE.getInterface_BusRef(),
				 true,
				 false,
				 false,
	...
	protected void addComponentRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_componentRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_componentRef_feature", "_UI_Interface_type"),
				 _1Package.eINSTANCE.getInterface_ComponentRef(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Interface)object).getBusRef();
