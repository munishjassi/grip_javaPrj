...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>spirit</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class _1Example {
	...
	public static void main(String[] args) {
		...
		//
		System.out.printf("I am put here in example test begin");
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My._1"));
				DocumentRoot documentRoot = _1Factory.eINSTANCE.createDocumentRoot();
				AbstractionDefinitionType root = _1Factory.eINSTANCE.createAbstractionDefinitionType();
				documentRoot.setAbstractionDefinition(root);
			...
			for (int i = 0; i < args.length; ++i) {
				...
				try {
					...
					for (Iterator j = resource.getContents().iterator(); j.hasNext(); ) {
						System.out.println("\n Wow!! I am now inside try>loop>iterator");
