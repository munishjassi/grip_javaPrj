...
/**
 * This is the item provider adapter for a {@link org.spiritconsortium.xml.schema.spirit.spirit.ChannelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelTypeItemProvider
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBusInterfaceRefPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _1Package.eINSTANCE.getChannelType_Name(),
				 true,
				 false,
				 false,
	...
	protected void addDisplayNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChannelType_displayName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChannelType_displayName_feature", "_UI_ChannelType_type"),
				 _1Package.eINSTANCE.getChannelType_DisplayName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _1Package.eINSTANCE.getChannelType_Description(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Bus Interface Ref feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBusInterfaceRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChannelType_busInterfaceRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChannelType_busInterfaceRef_feature", "_UI_ChannelType_type"),
				 _1Package.eINSTANCE.getChannelType_BusInterfaceRef(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
