...
/**
 * This is the item provider adapter for a {@link org.spiritconsortium.xml.schema.spirit.spirit.ServiceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceType_initiative_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceType_initiative_feature", "_UI_ServiceType_type"),
				 _1Package.eINSTANCE.getServiceType_Initiative(),
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_1Package.eINSTANCE.getServiceType_ServiceTypeDefs());
			childrenFeatures.add(_1Package.eINSTANCE.getServiceType_VendorExtensions());
		}
	...
	public String getText(Object object) {
		InitiativeType labelValue = ((ServiceType)object).getInitiative();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_1Package.eINSTANCE.getServiceType_ServiceTypeDefs(),
				 _1Factory.eINSTANCE.createServiceTypeDefsType()));

		newChildDescriptors.add
			(createChildParameter
				(_1Package.eINSTANCE.getServiceType_VendorExtensions(),
