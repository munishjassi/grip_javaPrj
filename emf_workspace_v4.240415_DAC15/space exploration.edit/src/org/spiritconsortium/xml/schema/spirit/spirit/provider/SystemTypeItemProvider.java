...
/**
 * This is the item provider adapter for a {@link org.spiritconsortium.xml.schema.spirit.spirit.SystemType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SystemType_group_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SystemType_group_feature", "_UI_SystemType_type"),
				 _1Package.eINSTANCE.getSystemType_Group(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((SystemType)object).getGroup();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SystemType.class)) {
			case _1Package.SYSTEM_TYPE__GROUP:
