...
/**
 * This is the item provider adapter for a {@link org.spiritconsortium.xml.schema.spirit.spirit.ModelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelTypeItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_1Package.eINSTANCE.getModelType_Views());
			childrenFeatures.add(_1Package.eINSTANCE.getModelType_Ports());
			childrenFeatures.add(_1Package.eINSTANCE.getModelType_ModelParameters());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_1Package.eINSTANCE.getModelType_Views(),
				 _1Factory.eINSTANCE.createViewsType()));

		newChildDescriptors.add
			(createChildParameter
				(_1Package.eINSTANCE.getModelType_Ports(),
				 _1Factory.eINSTANCE.createPortsType1()));

		newChildDescriptors.add
			(createChildParameter
				(_1Package.eINSTANCE.getModelType_ModelParameters(),
				 _1Factory.eINSTANCE.createModelParametersType()));
	}
