...
wire [63:0] output_V_data_V_dout;
wire [0:0]  output_V_data_V_empty_n;
wire [7:0]  output_V_keep_V_dout;
wire [0:0]  output_V_keep_V_empty_n;
wire [7:0]  output_V_strb_V_dout;
...
assign TSTRB  = m_data[79:72];
assign TUSER  = m_data[80:80];
assign TLAST  = m_data[81:81];
assign TID    = m_data[82:82];
assign TDEST  = m_data[83:83];
