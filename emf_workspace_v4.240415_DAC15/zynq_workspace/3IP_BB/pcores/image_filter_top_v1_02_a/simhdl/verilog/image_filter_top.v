...
input [64 - 1:0] INPUT_STREAM_TDATA ;
input [8 - 1:0] INPUT_STREAM_TKEEP ;
input [8 - 1:0] INPUT_STREAM_TSTRB ;
...
output [64 - 1:0] OUTPUT_STREAM_TDATA ;
output [8 - 1:0] OUTPUT_STREAM_TKEEP ;
output [8 - 1:0] OUTPUT_STREAM_TSTRB ;
...
wire [64 - 1:0] INPUT_STREAM_TDATA;
wire [8 - 1:0] INPUT_STREAM_TKEEP;
wire [8 - 1:0] INPUT_STREAM_TSTRB;
...
wire [64 - 1:0] OUTPUT_STREAM_TDATA;
wire [8 - 1:0] OUTPUT_STREAM_TKEEP;
wire [8 - 1:0] OUTPUT_STREAM_TSTRB;
