...
public class GlobalVars {
	...
	//public static final List<String> BUS_INSTANCES = Arrays.asList("axi_0", "axi_1");
	...
	// public static final String LIB_DIR_PATH = "/home/admin/Development/java_workspace/emf_workspace/data/hw/library_arm/v1";
	
	
	
	public static final String InDes = "../data/hw/inputdes/arch0";
	public static final String OutDir = "../data/hw/outputdes_temp2/";
...
//	public static final String InDes = "../data/hw/outputdes/archn3";
//	public static final String OutDes = "../data/hw/outputdes/archn4.2";
//	public static final String ApplyRule = "../data/hw/rules/rule2_addER_PP";
}
