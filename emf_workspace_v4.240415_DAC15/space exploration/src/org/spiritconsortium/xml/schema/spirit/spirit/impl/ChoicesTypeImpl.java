 ...
 * @generated
 */
public class ChoicesTypeImpl extends EObjectImpl implements ChoicesType {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getChoicesType();
	}
	...
	public EList getChoice() {
		if (choice == null) {
			choice = new EObjectContainmentEList(ChoiceType.class, this, _1Package.CHOICES_TYPE__CHOICE);
		}
		return choice;
	}
