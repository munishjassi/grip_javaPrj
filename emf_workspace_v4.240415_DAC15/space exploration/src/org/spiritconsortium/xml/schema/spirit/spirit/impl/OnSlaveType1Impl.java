 ...
 * @generated
 */
public class OnSlaveType1Impl extends EObjectImpl implements OnSlaveType1 {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getOnSlaveType1();
	}
	...
	public void setPresence(PresenceType newPresence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE1__PRESENCE, oldPresence, presence, !oldPresenceESet));
	}
	...
	public void unsetPresence() {
		...
		presenceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.ON_SLAVE_TYPE1__PRESENCE, oldPresence, PRESENCE_EDEFAULT, oldPresenceESet));
	}
	...
	public void setWidth(BigInteger newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE1__WIDTH, oldWidth, width));
	}
	...
	public void setDirection(DirectionType newDirection) {
		...
		directionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE1__DIRECTION, oldDirection, direction, !oldDirectionESet));
	}
	...
	public void unsetDirection() {
		...
		directionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.ON_SLAVE_TYPE1__DIRECTION, oldDirection, DIRECTION_EDEFAULT, oldDirectionESet));
	}
	...
	public NotificationChain basicSetModeConstraints(AbstractionDefPortConstraintsType newModeConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE1__MODE_CONSTRAINTS, oldModeConstraints, newModeConstraints);
	...
	public void setModeConstraints(AbstractionDefPortConstraintsType newModeConstraints) {
		if (newModeConstraints != modeConstraints) {
			...
			if (modeConstraints != null)
				msgs = ((InternalEObject)modeConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.ON_SLAVE_TYPE1__MODE_CONSTRAINTS, null, msgs);
			if (newModeConstraints != null)
				msgs = ((InternalEObject)newModeConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.ON_SLAVE_TYPE1__MODE_CONSTRAINTS, null, msgs);
			msgs = basicSetModeConstraints(newModeConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE1__MODE_CONSTRAINTS, newModeConstraints, newModeConstraints));
	}
	...
	public NotificationChain basicSetMirroredModeConstraints(AbstractionDefPortConstraintsType newMirroredModeConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE1__MIRRORED_MODE_CONSTRAINTS, oldMirroredModeConstraints, newMirroredModeConstraints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMirroredModeConstraints(AbstractionDefPortConstraintsType newMirroredModeConstraints) {
		if (newMirroredModeConstraints != mirroredModeConstraints) {
			...
			if (mirroredModeConstraints != null)
				msgs = ((InternalEObject)mirroredModeConstraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _1Package.ON_SLAVE_TYPE1__MIRRORED_MODE_CONSTRAINTS, null, msgs);
			if (newMirroredModeConstraints != null)
				msgs = ((InternalEObject)newMirroredModeConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _1Package.ON_SLAVE_TYPE1__MIRRORED_MODE_CONSTRAINTS, null, msgs);
			msgs = basicSetMirroredModeConstraints(newMirroredModeConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.ON_SLAVE_TYPE1__MIRRORED_MODE_CONSTRAINTS, newMirroredModeConstraints, newMirroredModeConstraints));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _1Package.ON_SLAVE_TYPE1__MODE_CONSTRAINTS:
				return basicSetModeConstraints(null, msgs);
			case _1Package.ON_SLAVE_TYPE1__MIRRORED_MODE_CONSTRAINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _1Package.ON_SLAVE_TYPE1__PRESENCE:
				return getPresence();
			case _1Package.ON_SLAVE_TYPE1__WIDTH:
				return getWidth();
			case _1Package.ON_SLAVE_TYPE1__DIRECTION:
				return getDirection();
			case _1Package.ON_SLAVE_TYPE1__MODE_CONSTRAINTS:
