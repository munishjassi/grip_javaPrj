 ...
 * @generated
 */
public class BaseAddressTypeImpl extends EObjectImpl implements BaseAddressType {
	/**
	...
	protected EClass eStaticClass() {
		return _1Package.eINSTANCE.getBaseAddressType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__VALUE, oldValue, value));
	}
	...
	public void setBitStringLength(BigInteger newBitStringLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__BIT_STRING_LENGTH, oldBitStringLength, bitStringLength));
	}
	...
	public void setChoiceRef(String newChoiceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__CHOICE_REF, oldChoiceRef, choiceRef));
	}
	...
	public void setConfigGroups(List newConfigGroups) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__CONFIG_GROUPS, oldConfigGroups, configGroups));
	}
	...
	public void setDependency(String newDependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__DEPENDENCY, oldDependency, dependency));
	}
	...
	public void setFormat(FormatType newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.BASE_ADDRESS_TYPE__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__ID, oldId, id));
	}
	...
	public void setMaximum(String newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMinimum(String newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setOrder(float newOrder) {
		...
		orderESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__ORDER, oldOrder, order, !oldOrderESet));
	}
	...
	public void unsetOrder() {
		...
		orderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.BASE_ADDRESS_TYPE__ORDER, oldOrder, ORDER_EDEFAULT, oldOrderESet));
	}
	...
	public void setPrompt(String newPrompt) {
		...
		promptESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__PROMPT, oldPrompt, prompt, !oldPromptESet));
	}
	...
	public void unsetPrompt() {
		...
		promptESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.BASE_ADDRESS_TYPE__PROMPT, oldPrompt, PROMPT_EDEFAULT, oldPromptESet));
	}
	...
	public void setRangeType(RangeTypeType newRangeType) {
		...
		rangeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__RANGE_TYPE, oldRangeType, rangeType, !oldRangeTypeESet));
	}
	...
	public void unsetRangeType() {
		...
		rangeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.BASE_ADDRESS_TYPE__RANGE_TYPE, oldRangeType, RANGE_TYPE_EDEFAULT, oldRangeTypeESet));
	}
	...
	public void setResolve(ResolveType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _1Package.BASE_ADDRESS_TYPE__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _1Package.BASE_ADDRESS_TYPE__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _1Package.BASE_ADDRESS_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
